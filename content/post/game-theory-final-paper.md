...
|HELPER'S RELATION                              |EXPLANATION           |
|-----------------------------------------------|----------------------|
|Sexually mature, nonbreeding related sibling   |Delayed dispersal, ecological constraints                                                 |
                                                                       |
                                                Indirect fitness benefits (kin selection)        |
|Nonrelated adults                              |Reciprocal altruism   |
|Postreproductive females                       |Kin selection         |
|Fathers                                        |Resource provisioning |
|Juveniles                                      |Benefits of learning and gaining maternal experience                                            |
                                                                       |
                                                |Kin selection         |
                                                                       |
                                                |Age division of labor, mutual benefits, kin selection              |
