...
Let's assume that individual _A_ provides some aid to B, resulting in _B_'s increase of inclusive fitness. Let BeB refer to the benefit received by _B_, and _C_ the costs of providing aid. The indirect increment of _A's inclusive fitness is _B<sub>eB</sub> - C_. Consider the following cases:
